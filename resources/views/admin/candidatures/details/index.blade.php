    ...
    <div class="card mb-2">
        <div class="card-body">
            <h2 class="h5 page-title">    
                ...
                Detalhes da Candidatura para EStabelecimentos de Ensino{{-- $item->id --}}
            </h2>
        </div>
    </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-12">
                        <h2 class="h5 page-title" style="text-align: center">    
                          ...
                          <span style="color: black"><b style="color: black">&nbsp; &nbsp; &nbsp; &nbsp;Data de Nascimento:</b></span>&nbsp;<span> {{ $item->birthDate }}</span>
                          <span style="color: black"><b style="color: black">&nbsp;&nbsp;Idade:</b></span>&nbsp;<span> {{ $item->idade }}</span><br>
                          ...
                          <span style="color: black"><b style="color: black">Ficheiro BI:</b></span>&nbsp;<span><a href="/storage/{{ $item->identityCard }}" target="__blank">Visualizar BI</a></span><br>
                    ...
                    <div class="col-12">
                      ...
                      @endphp
                          ...
                          <span style="color: black"><b style="color: black">Curso que Candidatou-se:</b></span>&nbsp;<span> {{ $item->nameCourse }}</span>
                          <span style="color: black"><b style="color: black">&nbsp; &nbsp; &nbsp; &nbsp;Estabelecimento de Ensino:</b></span>&nbsp;<span> {{ $item->nameAcademy}}</span>

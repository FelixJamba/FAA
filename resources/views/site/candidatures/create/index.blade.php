...
<div class="titulo_form">
    <h2 style="text-align: center ">Preencher Candidatura</h2>
</div>
...
<form id="formulario" name="formulario" method="post"  enctype="multipart/form-data">
    ...
    @method('post')
              ...
              <div class="row" >
                <div class="col-xs-12 col-sm-3 col-md-4">
                  ...
                  <div class="col-xs-12 col-sm-3 col-md-4"  id="divEnsino">
                    ...
                    <select id="ensino" name="fk_idtypes_application" class="meuestilo" >
                ...
                <div class="col-xs-12 col-sm-3 col-md-4" name="estabelecimento" id="estabelecimento" style="display: none;" required>
                    <label>Estabelecimento de Ensino</label>
                    <select id="est" class="meuestilo border-secondary" name="fk_idacademy">
                        <option>Seleccione uma opcção</option>
                ...
                <div class="col-xs-12 col-sm-3 col-md-4" name="estabelecimento1" id="estabelecimento" style="display: none;" required>
                    <label>Estabelecimento de Ensino</label>
         ...
         <input type="button" name="next2" class="next acao" value="Próximo"><br><br><br>
            ...
            <hr>
             <div class="row">
               ...
               <div class="col-xs-12 col-sm-3 col-md-3">
                ...
                <div class="col-xs-12 col-sm-3 col-md-3" id="curso" style="">
                ...
                <div class="col-xs-12 col-sm-3 col-md-3" id="curso" style="display: none;">
                    <label>Curso Para Candidatura</label>
                    <select class="meuestilo" id="selecCurso" name="fk_idcourse1" required>
...
<input type="button" name="prev" class="prev acao" value="Anterior"><input type="button" name="next3" class="next acao" value="Próximo" onclick="valida()"><br><br><br>
...
@if (session('create'))
    <script>
        Swal.fire({
            icon: 'success',
            title: 'Candidatura Enviada Aguarde a Recepção do E-mail!',
